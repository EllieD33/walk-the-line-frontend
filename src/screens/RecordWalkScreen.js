                ...
                (location) => {
                    ...
                    setUserLocationHistory((prev) => {
                        ...
                        if (distanceMoved > 0.0001) {
                            ...
                            setTotalAscent(
                                (previousAscent) => previousAscent + ascent
                            );
        ...
        >
            ...
            <View style={styles.info}>
                <View style={styles.metric}>
                    ...
                    />
                    <Text
                        style={[globalStyles.textDarkLarge, { marginLeft: 4 }]}
                    >
                ...
                <View style={styles.metric}>
                    ...
                    />
                    <Text
                        style={[globalStyles.textDarkLarge, { marginLeft: 6 }]}
                    >
